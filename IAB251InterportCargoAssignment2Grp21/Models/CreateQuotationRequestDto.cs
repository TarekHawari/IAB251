...
namespace IAB251InterportCargoAssignment2Grp21.Models
{
    public class CreateQuotationRequestDto
    {
        ...
        [Range(0.01, 10000, ErrorMessage = "Package width must be entered in millimetres and must be greater than 0.")]
        public decimal PackageWidth { get; set; }

        [Range(0.01, 10000, ErrorMessage = "Package height must be entered in millimetres and must be greater than 0.")]
